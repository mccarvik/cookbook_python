...
_lr_productions = [
  ...
  ('expr -> expr PLUS term','expr',3,'p_expr','2_19_recurse_parser.py',179),
  ('expr -> expr MINUS term','expr',3,'p_expr','2_19_recurse_parser.py',180),
  ('expr -> term','expr',1,'p_expr_term','2_19_recurse_parser.py',190),
  ('term -> term TIMES factor','term',3,'p_term','2_19_recurse_parser.py',196),
  ('term -> term DIVIDE factor','term',3,'p_term','2_19_recurse_parser.py',197),
  ('term -> factor','term',1,'p_term_factor','2_19_recurse_parser.py',206),
  ('factor -> NUM','factor',1,'p_factor','2_19_recurse_parser.py',212),
  ('factor -> LPAREN expr RPAREN','factor',3,'p_factor_group','2_19_recurse_parser.py',220),
]
